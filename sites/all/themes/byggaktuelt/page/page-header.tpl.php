<?php
// $Id: page-header.tpl.php,v 1.1 2010/09/21 12:57:34 pos Exp $
/**
...
<head>
  ...
  <?php print $styles ?>
  <?php print $scripts ?>
  <!--[if lt IE 8]><?php print openpublish_get_ie_styles(); ?><![endif]-->
...
<body <?php print openpublish_body_classes($left, $right, $body_classes); ?> >
  ...
  <div id="logo-area" class="clearfix">	    
    <div id="logo"><a href="<?php print check_url($front_page); ?>" title="<?php print check_plain($site_name); ?>"></a>
    </div><!--/ #logo -->
    ...
    <div id="top-menu" class="clearfix">
      <ul id="login-menu">
        ...
        <?php else : ?>
          <li class="hello"><?php //print t('Hej Gjest!'); ?></li>
